...
void ui_event_Panel1(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_VALUE_CHANGED) {
        _ui_label_set_property(ui_Label3, _UI_LABEL_PROPERTY_TEXT, "LIGHT ON");
    }
}
...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_style_bg_color(ui_Panel1, lv_color_hex(0x1A1A1A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Panel2, lv_color_hex(0x1A1A1A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Panel3, lv_color_hex(0x1A1A1A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Panel4, lv_color_hex(0x1A1A1A), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_x(ui_Label12, 135);
    lv_obj_set_y(ui_Label12, -184);
