...
RT_USED const struct sec_configuration sec_config =
{
    ...
    .ftab[2] = {.base = 0x12820000, .size = 0x00060000,  .xip_base = 0x12820000, .flags = 0},
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU)] = {.length = 0x00116DBC, .blksize = 512, .flags = DFU_FLAG_AUTO},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_LCPU)] = {.length = 0x0005196C, .blksize = 512, .flags = DFU_FLAG_AUTO},
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_BL)] = {.length = 0x0000E428, .blksize = 512, .flags = DFU_FLAG_AUTO},
    ...
    .imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_HCPU2)] = {.length = 0x00116DBC, .blksize = 512, .flags = DFU_FLAG_AUTO},
    ...
    .running_imgs[CORE_LCPU] = (struct image_header_enc *)&(((struct sec_configuration *)FLASH_TABLE_START_ADDR)->imgs[DFU_FLASH_IMG_IDX(DFU_FLASH_IMG_LCPU)]),
